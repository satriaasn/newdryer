...
INSERT INTO users (id, email, full_name, role) VALUES
  ('u1000000-0000-0000-0000-000000000001', 'superadmin@dryer.app', 'Budi Santoso', 'administrator'),
  ('u1000000-0000-0000-0000-000000000002', 'admin@dryer.app', 'Siti Rahayu', 'admin'),
  ('u1000000-0000-0000-0000-000000000003', 'gapoktan1@dryer.app', 'Haji Ahmad', 'gapoktan'),
...
INSERT INTO komoditas (id, name) VALUES
  ('k1000000-0000-0000-0000-000000000001', 'Padi'),
  ('k1000000-0000-0000-0000-000000000002', 'Jagung'),
  ('k1000000-0000-0000-0000-000000000003', 'Kedelai'),
  ('k1000000-0000-0000-0000-000000000004', 'Kopi'),
  ('k1000000-0000-0000-0000-000000000005', 'Kakao'),
  ('k1000000-0000-0000-0000-000000000006', 'Cengkeh');

-- Gapoktan-Komoditas links
INSERT INTO gapoktan_komoditas (gapoktan_id, komoditas_id) VALUES
  ('g1000000-0000-0000-0000-000000000001', 'k1000000-0000-0000-0000-000000000001'),
  ('g1000000-0000-0000-0000-000000000001', 'k1000000-0000-0000-0000-000000000002'),
  ('g1000000-0000-0000-0000-000000000001', 'k1000000-0000-0000-0000-000000000004'),
  ('g1000000-0000-0000-0000-000000000002', 'k1000000-0000-0000-0000-000000000001'),
  ('g1000000-0000-0000-0000-000000000002', 'k1000000-0000-0000-0000-000000000003'),
  ('g1000000-0000-0000-0000-000000000003', 'k1000000-0000-0000-0000-000000000004'),
  ('g1000000-0000-0000-0000-000000000003', 'k1000000-0000-0000-0000-000000000005'),
  ('g1000000-0000-0000-0000-000000000003', 'k1000000-0000-0000-0000-000000000006'),
  ('g1000000-0000-0000-0000-000000000004', 'k1000000-0000-0000-0000-000000000001'),
  ('g1000000-0000-0000-0000-000000000004', 'k1000000-0000-0000-0000-000000000002'),
  ('g1000000-0000-0000-0000-000000000005', 'k1000000-0000-0000-0000-000000000001'),
  ('g1000000-0000-0000-0000-000000000005', 'k1000000-0000-0000-0000-000000000005');

-- Dryer Units (gapoktan can own multiple)
INSERT INTO dryer_units (id, name, gapoktan_id, capacity_kg, status) VALUES
  ('d1000000-0000-0000-0000-000000000001', 'Dryer Unit A1', 'g1000000-0000-0000-0000-000000000001', 5000, 'active'),
  ('d1000000-0000-0000-0000-000000000002', 'Dryer Unit A2', 'g1000000-0000-0000-0000-000000000001', 3000, 'active'),
  ('d1000000-0000-0000-0000-000000000003', 'Dryer Unit B1', 'g1000000-0000-0000-0000-000000000002', 4000, 'active'),
  ('d1000000-0000-0000-0000-000000000004', 'Dryer Unit B2', 'g1000000-0000-0000-0000-000000000002', 4000, 'maintenance'),
  ('d1000000-0000-0000-0000-000000000005', 'Dryer Unit C1', 'g1000000-0000-0000-0000-000000000003', 6000, 'active'),
  ('d1000000-0000-0000-0000-000000000006', 'Dryer Unit D1', 'g1000000-0000-0000-0000-000000000004', 3500, 'active'),
  ('d1000000-0000-0000-0000-000000000007', 'Dryer Unit D2', 'g1000000-0000-0000-0000-000000000004', 3500, 'inactive'),
  ('d1000000-0000-0000-0000-000000000008', 'Dryer Unit E1', 'g1000000-0000-0000-0000-000000000005', 5000, 'active');
...
INSERT INTO productions (dryer_id, gapoktan_id, komoditas_id, qty_before, price_before, qty_after, price_after, production_date, notes) VALUES
  ('d1000000-0000-0000-0000-000000000001', 'g1000000-0000-0000-0000-000000000001', 'k1000000-0000-0000-0000-000000000001', 1000, 5000, 850, 7500, '2026-03-15', 'Batch padi musim hujan'),
  ('d1000000-0000-0000-0000-000000000002', 'g1000000-0000-0000-0000-000000000001', 'k1000000-0000-0000-0000-000000000002', 800, 4000, 720, 6000, '2026-03-16', 'Jagung kualitas A'),
  ('d1000000-0000-0000-0000-000000000001', 'g1000000-0000-0000-0000-000000000001', 'k1000000-0000-0000-0000-000000000004', 500, 35000, 420, 55000, '2026-03-18', 'Kopi Arabika'),
  ('d1000000-0000-0000-0000-000000000003', 'g1000000-0000-0000-0000-000000000002', 'k1000000-0000-0000-0000-000000000001', 1200, 5000, 1020, 7200, '2026-03-20', 'Padi varietas unggul'),
  ('d1000000-0000-0000-0000-000000000003', 'g1000000-0000-0000-0000-000000000002', 'k1000000-0000-0000-0000-000000000003', 600, 8000, 540, 12000, '2026-03-22', 'Kedelai lokal'),
  ('d1000000-0000-0000-0000-000000000005', 'g1000000-0000-0000-0000-000000000003', 'k1000000-0000-0000-0000-000000000005', 400, 25000, 350, 40000, '2026-03-25', 'Kakao fermentasi'),
  ('d1000000-0000-0000-0000-000000000005', 'g1000000-0000-0000-0000-000000000003', 'k1000000-0000-0000-0000-000000000006', 300, 80000, 270, 120000, '2026-03-26', 'Cengkeh kering'),
  ('d1000000-0000-0000-0000-000000000006', 'g1000000-0000-0000-0000-000000000004', 'k1000000-0000-0000-0000-000000000001', 900, 5000, 765, 7800, '2026-03-27', 'Padi IR64'),
