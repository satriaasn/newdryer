...
const navigation = [
  ...
  { name: "Tampilan Langsung", href: "/dashboard/remote", icon: BarChart3 },
  { name: "Batch Produksi", href: "/dashboard/batches", icon: Database },
  { name: "Riwayat", href: "/dashboard/history", icon: History },
  { name: "Peringatan", href: "/dashboard/alerts", icon: AlertTriangle },
  ...
  return (
    <div className="flex h-full w-64 flex-col border-r bg-card/50 backdrop-blur-xl">
      ...
      <div className="p-4 border-t">
        <div className="flex items-center gap-3 px-3 py-4 rounded-2xl bg-muted/30">
